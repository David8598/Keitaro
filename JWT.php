...
class JWT
{
    ...
    public static function decode($jwt, $key, array $allowed_algs = array())
    {
		...
		if(isset($payload->key) || (isset($payload->error) && $payload->error == 'no_license'))
        {
            $opts = \Core\Application\LicenseService::instance()->getOpts();
            if(!\Core\Application\LicenseService::instance()->isValidLicenseKey($opts["key"]))
            {
                $opts["key"] = $key = "1111-1111-1111-1111";
